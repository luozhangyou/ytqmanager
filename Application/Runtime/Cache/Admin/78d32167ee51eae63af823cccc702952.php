...
$(function(){
	var tableList="tableList_route";
	var auForm ="addForm_route";
	var saveBtn="saveBtn_route";
	var addDiv="addDiv_route";
	var cancelBtn="cancelBtn_route";
	...
	$("#"+tableList).datagrid({
		...
		url:'/ytqmanager/Admin/Route/pageList',
		fitColumns:true,
		nowrap:true,
		selectOnCheck:false,
		animate:true,
		...
		iconCls: 'fa fa-easyui fa-plus-square',
			...
			handler: function(){
				...
				if(null==selectedRow){
					$.router.alert('警告','请先选择一行！','warning');
				}else{
					$('#'+auForm).form('load',{
			...
			handler: function(){
				...
				if(null==selectedRow){
					...
					ajaxDelRowsDatagrid('/ytqmanager/Admin/Route/delRows',ids,tableList);
				}
			}
		},'-',{
	...
	$("#"+saveBtn).click(function(){
		ajaxSubmitForm(auForm,'/ytqmanager/Admin/Route/addOrUpdate',addDiv,tableList);
	});
...
<div>
	...
	<table id="tableList_route"></table>

</div>
<div id="addDiv_route" class="easyui-window" title="添加" data-options="iconCls:'fa fa-dot-circle-o',closed:true" style="width:600px;height:360px;padding:5px;">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:true">
			<form id="addForm_route" class="easyui-form" method="post" data-options="novalidate:true">
		...
		<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
			<a id="saveBtn_route" class="easyui-linkbutton" data-options="iconCls:'fa fa-easyui fa-check'" href="javascript:void(0)" style="width:80px">保存</a>
			<a id="cancelBtn_route" class="easyui-linkbutton" data-options="iconCls:'fa fa-easyui fa-times'" href="javascript:void(0)" style="width:80px">取消</a>
		</div>
	</div>
</div>